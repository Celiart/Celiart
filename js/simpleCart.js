			...
			simpleCart.extend({
				checkout: function () {
					if (settings.checkout.type.toLowerCase() === 'custom' && isFunction(settings.checkout.fn)) {
						...
						simpleCart.error("No Valid Plaseaza comanda Method Specified");
					}
				},
			...
			simpleCart.extendCheckout({
				...
				GoogleCheckout: function (opts) {
					...
					if (simpleCart.currency().code !== "USD" && simpleCart.currency().code !== "GBP") {
						return simpleCart.error("Google Plaseaza comanda only accepts USD and GBP");
					}
				...
				SendForm: function (opts) {
					// url required
					if (!opts.url) {
						return simpleCart.error('URL required for SendForm Plaseaza comanda');
					}
